...
/**
 * AbstractUUIDModelObject
 *
 * @author <a href="mailto:jkashimba@hakano.com">Jared Kashimba</a>
 */
@MappedSuperclass
public class AbstractUUIDModelObject extends AbstractModelObject
{
    @Column(name = "__UUID__", unique = true, nullable = false, updatable = false, length = 36)
    private String internalUUID;
    private int hashCode;

    public AbstractUUIDModelObject()
    {
        internalUUID = GUID.asGUID();
        hashCode = internalUUID.hashCode();
    }
    ...
    public void setInternalUUID(String internalUUID)
    {
        ...
        this.hashCode = this.internalUUID.hashCode();
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final AbstractUUIDModelObject that = (AbstractUUIDModelObject) obj;

        return internalUUID.equals(that.internalUUID);
    }
