...
Appcelerator.Core.requireCommonJS = function (name,onload)
{
    ...
    if (Object.isArray(name))
    {
        ...
        var loader = function()
        {
            ...
            {
                Appcelerator.Core.requireCommonJS(name[idx],loader);                    
            }
        };
        Appcelerator.Core.requireCommonJS(name[idx],loader);
    }
    ...
    {
	    var path = Appcelerator.Core.getModuleCommonDirectory()+'/js/'+name;
	    var loaded = Appcelerator.Core.usedJS[path];
	    if (loaded)
	    {
	        if (Object.isFunction(onload)) onload();
	    }
	    ...
	    {
	        Appcelerator.Core.loadJS(path,function()
	        {
	            Appcelerator.Core.usedJS[path]=true;
	            if (Object.isFunction(onload)) onload();
	        },true);
	    }
	}
...
Appcelerator.Core.loadJS = function (path, onload, track)
{
	...
	{
		// because of load order, widgets generated by app:widget will print this
		$D('Error loading '+path+'\n Exception: '+Object.getExceptionDetail(e));
	};
	if (track)
	{
	    var loader = function()
