...
Appcelerator.Widget.Field =
{
	...
	buildWidget: function(element, parameters)
	{
		...
		var title = '';
		var description = '';
		var errorIcon = Appcelerator.Widget.Field.modulePath + 'images/bullet_error.png';	
...
Appcelerator.Widget.register('app:field',Appcelerator.Widget.Field);
