...
Appcelerator.Widget.AppRss =
{
	...
	{
		//TODO
		return 'app:rss is the coolest widget in the world!';
	},
	/**
	...
	getActions: function()
	{
		/* 
		  ...
		  You can then do something like:  
		     ...
		     <app:rss on="l:some.message then execute"></app:rss>
	...
	/**
	 * this method will be called each time a <app:rss> is encountered in a page. the return object gives
	 * instructions to the compiler about how to process the widget.
	 *
	 * @param {element} dom element for the <app:rss> encountered in the page
	 * @param {object} parameters object for the attributes that <app:rss> supports
	 */
	buildWidget: function(element,parameters)
	{
		//TODO - this is optional, but usually is the HTML to replace for <app:rss>
		var html = 'Hello from the <tt>&lt;app:rss&rt;</tt> widget!';
		
		return {
			'presentation' : html,   // this is the HTML to replace for the contents <app:rss>
			'position' : Appcelerator.Compiler.POSITION_REPLACE,  // usually the default, could be POSITION_REMOVE to remove <app:rss> entirely
...
reference it here. For example:
    ...
    Appcelerator.Core.loadModuleCSS('app:rss','mystyles.css');
...
directory and use registerWidgetWithJS. For example:
    ...
    Appcelerator.Core.registerModuleWithJS('app:rss',Appcelerator.Widget.AppRss,['a.js', 'b.js']);
...
For example:
	...
	{
	    Appcelerator.Core.registerModuleWithJS('app:rss',Appcelerator.Widget.AppRss,['a.js']);
	});

*/

Appcelerator.Core.registerModule('app:rss',Appcelerator.Widget.AppRss);
